...
description:
  Integration guide for React Router (formerly Remix) with Sanity, including Loaders and Visual
  Editing.
---
...
To support both server-side fetching and client-side live previews, use the **Split Loader
Pattern**.
