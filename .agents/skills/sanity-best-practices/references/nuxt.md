...
Use the composable provided by the module for reactive fetching. It automatically handles preview
...
Just like Next.js, if you use stega-encoded strings in logic (e.g. `v-if="post.layout === 'full'"`),
you must clean them.
