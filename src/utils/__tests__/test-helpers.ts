import type { MigrationAudioBlock, MigrationImageBlock, MigrationVideoBlock, MigrationTextBlock } from '@/types/migration'

// Helper functions to create test migration blocks with proper types

export function createTestAudioBlock(overrides: Partial<MigrationAudioBlock> = {}): MigrationAudioBlock {
  return {
    _type: 'audio',
...
export function createTestImageBlock(overrides: Partial<MigrationImageBlock> = {}): MigrationImageBlock {
  return {
    _type: 'image',
...
export function createTestVideoBlock(overrides: Partial<MigrationVideoBlock> = {}): MigrationVideoBlock {
  return {
    _type: 'video',
...
export function createTestTextBlock(overrides: Partial<MigrationTextBlock> = {}): MigrationTextBlock {
  return {
    _type: 'block',
